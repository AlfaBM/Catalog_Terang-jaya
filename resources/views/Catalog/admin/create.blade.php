...
<div class="col-6 m-auto mt-3">
    <form action="{{ Route('Catalog.admin.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3 text-start">
            ...
            <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" id="deskripsi" rows="3" placeholder="Max 1000 Character" required autocomplete="off"></textarea>
            @error('deskripsi')
        ...
        <div class="mb-3 text-start">
            ...
            <input class="form-control @error('ukuran') is-invalid @enderror" placeholder="10kg/10inch/10m etc." type="text" name="ukuran" id="ukuran" required>
            @error('ukuran')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3 text-start">
            ...
            <input class="form-control @error('harga') is-invalid @enderror" placeholder="(hanya angka)" type="text" name="harga" id="harga" required>
            @error('harga')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
