    ...
    <div class="container pt-5">
        <div class="row pt-5">
            <div class="col-sm-4 hidden2">
                <img class="cat-show" src="{{ asset('storage/' . $catalog['gambar']) }}" alt=""
            ...
            <div class="col-sm-6">
                ...
                <div class="text-start mt-2">
                    ...
                    <p class="hidden4">Harga per unit : {{ 'RP.' . number_format(floatval($catalog['harga']), 0, ',', '.') }}
                    </p>
                    <p class="hidden4">Deskripsi : </p>
                    <p class="hidden3" style="white-space: pre;">{{ $catalog['deskripsi'] }}</p>
                </div>
                <div class="d-flex justify-content-center pt-3 pb-2 hidden3" style="gap:50px">
                    <a class="btn btn-success " href="http://wa.me/+628813542629" target="_blank"><svg
